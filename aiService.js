...
المطلوب: إنشاء ملزمة / مراجعة تعليمية جميلة ومنظمة، مقسمة على عدد الصفحات المناسب بحسب طول المحتوى. استخدم عناوين واضحة، بطاقات مرتبة، جداول عند الحاجة، ومسافات مريحة، ولا تكدّس المعلومات.
🟢 **اللغة الإلزامية:** كل النصوص الظاهرة للقارئ باللغة العربية فقط، بما فيها العناوين والأزرار والجداول والتعليقات. لا تستخدم مصطلحات أو عناوين إنجليزية؛ يسمح فقط بالرموز الرياضية والوحدات العلمية القياسية عند الضرورة.
