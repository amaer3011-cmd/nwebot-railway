...
2. **الأسئلة:** كل سؤال مرقم بوضوح مع 4 اختيارات في أربعة أسطر مستقلة بالترتيب (أ)، (ب)، (ج)، (د)، مع دوائر أو مربعات اختيار فارغة ☐. ممنوع دمج الاختيارات في سطر واحد أو فصلها بمسافات أفقية.
...
- اكتب الجذر دائماً \\\\sqrt{...} بدون مسافات زائدة، ولا تستخدم v أو V كبديل للجذر، ولا تكتب صيغة مثل \\\\sqrt{}(2\\times500/10).
