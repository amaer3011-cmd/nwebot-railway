...
2. **الأسئلة المقالية والتحليلية:** اذكر المعطيات والمطلوب والوحدات بوضوح، ثم أضف بعد كل سؤال مساحة بعنوان «مساحة خطتك وحلك باليد (فكر وحل هنا أولاً):» مع 3–5 أسطر مخصصة للحل.
3. **مساحة «حل بإيدك»:** استخدم مساحة مخططة كلاس \.workspace-area\` بعد كل سؤال، واضبط التوزيع حتى لا يحدث تزاحم أو قص في الصفحة.
